...
namespace LifeSpot
{
    public static class EndpointMapper
    {
        ...
        {
            var jsFiles = new[] { "script.js", "testing.js", "about.js" };
        ...
        ///  Маппинг IMG
        /// </summary>
        public static void MapImg(this IApplicationBuilder app)
        {
        ...
        public static void MapNodes(this IApplicationBuilder app) { 
            app.UseStaticFiles(new StaticFileOptions
            {
